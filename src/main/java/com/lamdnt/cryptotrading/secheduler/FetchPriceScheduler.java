...
public class FetchPriceScheduler {
    ...
    public void priceAggregationTask() {
        ...
        Map<String, Pair<BigDecimal, BigDecimal>> prices = priceAggregationService.getAggregationPrice(
                tradingPairs.stream()
    ...
    public void updateTradingPairPrice(TradingPair tradingPair, BigDecimal askPrice, BigDecimal bidPrice) {
